...
x_train=model.matrix(MSRP~.+I(Year^2)+I(Year^3)+I(highway.MPG^2)+I(city.mpg^2) + I(Popularity^2) + I(Popularity^3)+ I(Engine.HP.Clean^2),train)[, -1]
y_train=log(train$MSRP)
x_test<-model.matrix(MSRP~.+I(Year^2)+I(Year^3)+I(highway.MPG^2)+I(city.mpg^2) + I(Popularity^2) + I(Popularity^3)+ I(Engine.HP.Clean^2),test)[, -1]
...
myData %>% ggplot(aes(x=Popularity, y=log(MSRP))) + geom_smooth()
